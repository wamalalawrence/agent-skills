...
REQUIRED_FILES = [
    ...
    "skills/delivery-planner/SKILL.md",
    "skills/delivery-planner/README.md",
    "skills/delivery-planner/references/plan-quality-checklist.md",
    "skills/delivery-planner/references/phase-template.md",
