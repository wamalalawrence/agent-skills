...
- Read `destination.md` and the current `phase-NN-<slug>.md` from
  ...
  feel obvious.
- Open `evidence-pack.yml` from the same directory before refinement. If it is missing,
  ...
  `BLOCKED: phase continuity evidence-pack missing`; do not refine from Markdown files alone.
