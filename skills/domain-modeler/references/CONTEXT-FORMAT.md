...
- **Account**: Resolved 2026-05-20. Historically used for both Customer and User. Now
  canonical: Customer is the billing entity; User is the login identity.
```
...
live, and how they relate to each other:
